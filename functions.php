...
function wpbase_scripts() {
	wp_enqueue_style( 'wpbase-styles', get_template_directory_uri() . '/dist/css/main.css' );

	wp_enqueue_script( 'wpbase-scripts', get_template_directory_uri() . '/dist/js/site.js', array('jquery'), '20191023', true );
